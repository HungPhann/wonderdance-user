...
public class UpdateAchievementRequest {
    ...
    public UpdateAchievementRequest(@NotNull @NotBlank String title, @NotNull DanceGenreName dance_genre, @NotNull @NotBlank String competition, @NotNull @Min(1) Integer year) {
        this.title = title;
